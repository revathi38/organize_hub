...
const classLinkActive = "text-amber-600 bg-blue-100 border-r-4 border-amber-500 dark:bg-slate-700/[.2] dark:text-slate-200 dark:border-slate-200";
  ...
  return (
    <LayoutMenus menuOpen={menuOpen} closeMenuHandler={closeMenuHandler} className="left-0">
      <header className="h-full flex flex-col">
        <h1 className="font-bold uppercase text-center mt-8 text-lg tracking-wide hidden xl:block">Task Organizer</h1>
